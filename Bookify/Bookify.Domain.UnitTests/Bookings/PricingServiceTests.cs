...
{
    [Fact]
    public void CalculatePrice_WhenCalled_ReturnsCorrectTotalPrice()
    {
        // Arrange
    ...
    [Fact]
    public void CalculatePrice_WhenCalled_ReturnsCorrectTotalPrice_WhenCleaningFeeIsIncluded()
    {
        // Arrange
        var price = new Money(10.0m, Currency.Usd);
